...
namespace WalletConnectUnity.Core.Tests
{
    ...
    {
        [Test]
        public async void InitializeAsync_WhenNotInitialized_BecomesInitialized()
        {
        ...
        [Test]
        public async void InitializeAsync_WhenCalledInParallel_LogsErrorAndBecomesInitialized()
        {
            using var wc = new WalletConnect();
